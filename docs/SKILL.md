# MoonCode UI Design Skill

Bu dosya MoonCode için UI/TUI üreten ajanlar tarafından okunmalıdır. Amaç: generic AI arayüzü değil, kimliği olan profesyonel tasarım.

## MoonCode terminal paleti
