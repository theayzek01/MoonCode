...
Moodcli ships with powerful defaults but skips features like sub engines and plan mode. Instead, you can ask Moodcli to build what you want or install a third party Moodcli package that matches your workflow.
