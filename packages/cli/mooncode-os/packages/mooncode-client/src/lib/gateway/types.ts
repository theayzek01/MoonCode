// Protocol frame types matching MoonCode gateway protocol v3.
// Defined locally to avoid bundling the server-only `mooncode` package.
// Source of truth: https://github.com/mooncode/mooncode/blob/main/src/gateway/protocol/client-info.ts
// Schema definitions: https://github.com/mooncode/mooncode/blob/main/src/gateway/protocol/schema/

// Copied from src/gateway/protocol/client-info.ts — no subpath export exists for this.
export const GATEWAY_CLIENT_IDS = {
  WEBCHAT_UI: "webchat-ui",
  CONTROL_UI: "mooncode-control-ui",
  TUI: "mooncode-tui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "mooncode-macos",
  IOS_APP: "mooncode-ios",
  ANDROID_APP: "mooncode-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "mooncode-probe",
} as const;
...
// Field names are normalized by the gateway (see normalizeUsage in MoonCode source).
...
export interface ChatHistoryMessage {
  ...
  stopReason?: string;
  errorMessage?: string;
  __mooncode?: { id: string; seq: number; kind?: string };
}
