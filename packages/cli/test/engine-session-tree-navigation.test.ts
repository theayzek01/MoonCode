/**
 * E2E tests for EngineSession tree navigation with branch summarization.
 *
 * These tests verify:
...
describe.skipIf(!API_KEY)("EngineSession tree navigation e2e", () => {
	...
	it("should handle abort during summarization", async () => {
		...
		// Abort after a short delay (let the Provider call start)
...
describe.skipIf(!API_KEY)("EngineSession tree navigation - branch scenarios", () => {
	let ctx: TestSessionContext;
