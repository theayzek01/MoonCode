...
<html lang="tr">
<head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><title>MoonCode Dashboard</title><link rel="stylesheet" href="/style.css" /></head>
<body><div id="app"><header class="topbar"><div><b>MoonCode</b><span>workspace dashboard</span></div><nav><span>sessions</span><span>chat</span><span>stats</span></nav></header><aside><h1>Sessions</h1><p class="hint">Select a previous session.</p><div id="sessions"></div></aside><main><div id="chat" class="panel empty">Select a session</div></main><section><h2>Stats</h2><pre id="stats">-</pre></section></div><script src="/app.js"></script></body>
</html>`;
