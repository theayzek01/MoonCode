...
export interface LoadPromptTemplatesOptions {
	...
	cwd: string;
	/** Engine config directory for global templates. */
	engineDir: string;
...
export function loadPromptTemplates(options: LoadPromptTemplatesOptions): PromptTemplate[] {
	...
	const globalPromptsDir = options.engineDir ? join(options.engineDir, "prompts") : resolvedEngineDir;
