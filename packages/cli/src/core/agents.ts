...
export const DEFAULT_CODING_AGENT_PROFILES: readonly CodingAgentProfile[] = [
	{
		id: "patron",
		name: "Patron / Orchestrator",
		focus: "istegi hedefe, kapsam sinirina ve kabul kriterlerine cevirir; gereksiz isi keser",
	...
	},
	{
		...
		focus: "API, veri modeli, validasyon, hata yonetimi, guvenilir is kurallari",
		useWhen: "server, database, auth, provider, CLI runtime veya tool davranisi degisiyorsa",
	},
	{
		id: "frontend",
		name: "Frontend / UI Muhendisi",
		focus: "TUI/Web UI akis, durum gosterimi, erisilebilirlik, bos/yukleniyor/hata halleri",
		useWhen: "kullanici arayuzu, komut yardimi, layout veya interaksiyon degisiyorsa",
	},
	{
		id: "qa",
		name: "QA / Test Muhendisi",
...
4. QA, Security ve Integrator son kontrolden gecirir: calisma, edge case, test/komut, stil ve entegrasyon.
5. Final cevapta sadece entegre sonucu, degisen dosyalari ve dogrulamayi soyle.
