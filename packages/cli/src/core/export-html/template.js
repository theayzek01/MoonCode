    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="MoonCode-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="MoonCode-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'MoonCode-share:v1:sidebar-width';
