...
function getTempFilePath(): string {
	...
	return join(tmpdir(), `MoonAgent-bash-${id}.log`);
}
...
/**
 * Create bash operations using MoonAgent's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want MoonAgent's
