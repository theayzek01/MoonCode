...
export const BUILTIN_SLASH_COMMANDS: ReadonlyArray<BuiltinSlashCommand> = [
	...
	{ name: "index", description: "Proje kod tabanini semantik arama icin indexle (status|force)" },
	{ name: "ship", description: "Degisiklikleri branch+commit+push+PR akisiyle ship et" },
	{ name: "git", description: "Git durum/commit yardimcilari: /git status | /git commit <mesaj>" },
	{ name: "ollama", description: "Ollama model yonetimi: /ollama models | /ollama pull <model>" },
	{ name: "diff", description: "Son git diff/stat ciktisini goster" },
	{ name: "web", description: "Local Web-UI dashboard'u ac" },
	{ name: "marketplace", description: "Extension/skill/theme marketplace ara ve kur" },
];
