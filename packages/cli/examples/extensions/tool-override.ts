 ...
 * - Routing tool calls to remote systems (e.g., moodcli-ssh-remote)
...
import { type ExtensionAPI, getEngineDir, withFileMutationQueue } from "moodcli";
...
export default function (moodcli: ExtensionAPI) {
	...
	moodcli.registerCommand("read-log", {
