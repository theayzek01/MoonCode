 ...
 * - Routing tool calls to remote systems (e.g., Hodeus-ssh-remote)
 ...
 *
 * Usage:
 *   Hodeus -e ./tool-override.ts
 */

import { type ExtensionAPI, getEngineDir, withFileMutationQueue } from "Hodeus";
import { constants, readFileSync } from "fs";
import { access, appendFile, readFile } from "fs/promises";
import type { TextContent } from "hodeus-core";
import { join, resolve } from "path";
import { Type } from "typebox";

const LOG_FILE = join(getEngineDir(), "read-access.log");
...
export default function (Hodeus: ExtensionAPI) {
	...
	Hodeus.registerCommand("read-log", {
