...
Play DOOM as an overlay in MoonCode. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
MoonCode --extension ./examples/extensions/doom-overlay
```
...
- [MoonCode-doom](https://github.com/badlogic/MoonCode-doom) for the original MoonCode integration
