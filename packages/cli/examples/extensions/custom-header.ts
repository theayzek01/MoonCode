 ...
 * (logo + keybinding hints) with a custom component showing the moodcli mascot.
 */

import type { ExtensionAPI, Theme } from "moodcli";
import { VERSION } from "moodcli";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the moodcli engine character
...
export default function (moodcli: ExtensionAPI) {
	...
	moodcli.registerCommand("builtin-header", {
