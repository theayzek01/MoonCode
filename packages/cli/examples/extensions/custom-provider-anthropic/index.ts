 ...
 *   Hodeus -e ./packages/cli/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... Hodeus -e ./packages/cli/examples/extensions/custom-provider
 *
...
export default function (Hodeus: ExtensionAPI) {
	Hodeus.registerProvider("custom-anthropic", {
