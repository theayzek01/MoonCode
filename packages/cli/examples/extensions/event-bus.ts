 ...
 *
 * Shows Hodeus.events for communication between extensions. One extension
...
export default function (Hodeus: ExtensionAPI) {
	...
	Hodeus.events.on("my:notification", (data) => {
