...
import { AuthStorage, createEngineSession, ModelRegistry, SessionManager } from "MoonCode";

// Default: AuthStorage uses ~/.MoonCode/engine/auth.json
// ModelRegistry loads built-in + custom models from ~/.MoonCode/engine/models.json
