...
Reusable web UI components for building AI chat interfaces powered by [@moodcli/ai](../ai) and [@moodcli/agent-core](../agent).
...
```bash
npm install @moodcli/web-ui @moodcli/agent-core @moodcli/ai
```
...
```typescript
import { Agent } from '@moodcli/agent-core';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@moodcli/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@moodcli/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@moodcli/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@moodcli/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@moodcli/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@moodcli/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@moodcli/web-ui';
...
```typescript
import { SessionListDialog } from '@moodcli/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@moodcli/web-ui';
...
```typescript
import { ModelSelector } from '@moodcli/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@moodcli/web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using moodcli-web-ui
