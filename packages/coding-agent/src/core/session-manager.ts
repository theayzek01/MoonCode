 ...
 * Encodes cwd into a safe directory name under ~/.moodcli/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.moodcli/agent/sessions/<encoded-cwd>/).
	 */
