...
// ============================================================================
// OAuth API key resolution from ~/.moodcli/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".moodcli", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.moodcli/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.moodcli/agent/auth.json
 */
...
/** Path to the real moodcli agent config directory */
export const PI_AGENT_DIR = join(homedir(), ".moodcli", "agent");

/**
 * Get an AuthStorage instance backed by ~/.moodcli/agent/auth.json
