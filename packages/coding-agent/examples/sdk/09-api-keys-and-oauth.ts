...
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "moodcli";

// Default: AuthStorage uses ~/.moodcli/agent/auth.json
// ModelRegistry loads built-in + custom models from ~/.moodcli/agent/models.json
