 ...
 * Commands Extension
 *
 * Demonstrates the moodcli.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "moodcli";

export default function commandsExtension(moodcli: ExtensionAPI) {
	moodcli.registerCommand("commands", {
