...
Example extensions for moodcli-coding-agent.
...
cp permission-gate.ts ~/.moodcli/agent/extensions/
```
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using moodcli-ai's built-in Anthropic/OpenAI streaming via proxy |
