 ...
 * - ~/.moodcli/agent/extensions/sandbox.json (global)
 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.moodcli/agent/extensions/
 * 2. Run `npm install` in ~/.moodcli/agent/extensions/sandbox/
 *
...
import { type BashOperations, createBashTool, getAgentDir } from "moodcli";
