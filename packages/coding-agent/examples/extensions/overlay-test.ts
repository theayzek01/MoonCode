 ...
 *
 * Usage: moodcli --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@moodcli/tui";
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "moodcli";

export default function (moodcli: ExtensionAPI) {
	moodcli.registerCommand("overlay-test", {
