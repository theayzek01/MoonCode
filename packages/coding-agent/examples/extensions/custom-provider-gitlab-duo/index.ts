 ...
 * Delegates to moodcli-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   moodcli -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
