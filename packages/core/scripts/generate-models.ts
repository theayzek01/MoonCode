...
async function generateModels() {
	...
	// Antigravity models from ag-local-bridge
	const ANTIGRAVITY_ENDPOINT = "http://localhost:11435/v1";
	const antigravityModels: Model<"google-antigravity">[] = [
		{
			id: "antigravity-claude-sonnet-4-6",
			name: "Claude Sonnet 4.6 with Thinking",
		...
		},
		{
			...
			name: "Claude Opus 4.6 with Thinking",
			api: "google-antigravity",
			provider: "antigravity",
			baseUrl: ANTIGRAVITY_ENDPOINT,
			reasoning: true,
