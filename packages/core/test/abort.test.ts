...
async function testAbortThenNewMessage<TApi extends Api>(llm: Model<TApi>, options: StreamOptionsWithExtras = {}) {
	...
	// Add the aborted assistant message to context (this is what happens in the real coding engine)
...
describe("Core Providers Abort Tests", () => {
	...
	describe.skipIf(!process.env.Core_GATEWAY_API_KEY)("Vercel Core Gateway Provider Abort", () => {
