...
describe("Core Providers Unicode Surrogate Pair Tests", () => {
	...
	describe.skipIf(!process.env.XCore_API_KEY)("xCore Provider Unicode Handling", () => {
	...
	describe.skipIf(!hasCloudflareWorkersCoreCredentials())("Cloudflare Workers Core Provider Unicode Handling", () => {
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials())("Cloudflare Core Gateway Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.ZCore_API_KEY)("zCore Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.Core_GATEWAY_API_KEY)("Vercel Core Gateway Provider Unicode Handling", () => {
