...
export declare const streamGoogleAntigravity: StreamFunction<"google-antigravity", GoogleGeminiCliOptions>;
export declare const streamSimpleGoogleAntigravity: StreamFunction<"google-antigravity", SimpleStreamOptions>;
