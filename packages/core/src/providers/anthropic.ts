...
const FINE_GRCoreNED_TOOL_STREAMING_BETA = "fine-grained-tool-streaming-2025-05-14";
...
function createClient(
	...
	if (useFineGrainedToolStreamingBeta) {
		betaFeatures.push(FINE_GRCoreNED_TOOL_STREAMING_BETA);
	}
			...
			defaultHeaders: mergeHeaders(
				{
					...
					"user-engine": `claude-cli/${claudeCodeVersion}`,
					"x-app": "cli",
				},
				model.headers,
				optionsHeaders,
