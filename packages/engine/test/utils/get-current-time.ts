...
import type { EngineTool, EngineToolResult } from "../../src/types.js";

export interface GetCurrentTimeResult extends EngineToolResult<{ utcTimestamp: number }> {}
...
export const getCurrentTimeTool: EngineTool<typeof getCurrentTimeSchema, { utcTimestamp: number }> = {
	label: "Current Time",
