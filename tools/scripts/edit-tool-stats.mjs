...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".moodcli/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".moodcli/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.moodcli/agent/sessions)
